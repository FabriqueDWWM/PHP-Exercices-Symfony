...
Pour gérer vos versions de PHP, vous pouvez vous aider de (ceci)[https://tecadmin.net/install-php-7-on-ubuntu/] et (ceci)[https://www.ostechnix.com/how-to-switch-between-multiple-php-versions-in-ubuntu/].<br>
...
La correction se trouve [ici](https://github.com/FabriqueNumeriquePau/PHP/tree/master/3_STRUCTURE_D_APPLICATION_correction/correction/v1_routes/ppj).<br>
...
Vous vous êtes également imprégnés de la structure d'application présentée [ici](https://github.com/FabriqueNumeriquePau/PHP/tree/master/3_STRUCTURE_D_APPLICATION_correction/correction/ppj).
...
(Re)créer les pages dans Symfony et stocker les données (produits, articles de blog) en bdd. Faisons cela en plusieurs étapes...
 ...
 2. Configurez la bdd en modifiant la ligne : `DATABASE_URL="mysql://db_user:db_password@127.0.0.1:3306/db_name"` en remplaçant : 
 ...
 3. Dans le terminal, dans le dossier du projet, créez la base données en saisissant la commande :
    - php bin/console doctrine:database:create
    - Cela crée une base de données vide portant le nom que vous avez configuré dans le fichier .env
 4. Créez une entity Produit avec 2 champs : libelle (type string) et img (type string), à l'aide de la commande `php bin/console make:entity`.
 5. Créez une entity Blog avec 2 champs : titre (type string) et texte (type text) de la même façon.
 6. Générez les tables de la bdd avec les 2 commandes suivantes :
    - php bin/console make:migration
    - php bin/console doctrine:migrations:migrate
 7. Créez une méthode de controller associée à une route nommée `/produit/add`. 
